...
class MultiOutput(nn.Module):
    def __init__(self, model, mlp_hidden_dim=256, embed_size = 512):
        ...
        #regression head
        self.regression_head_1 = nn.Sequential(
    ...
    def forward(self, xrd, smiles):
        ...
        output_1 = self.regression_head_1(model_output)
        #output_2 = self.regression_head_2(model_output)
...
class loadMulti():
    ...
    def regressionMode(self):
        model = MultiOutput(self.model_pre).to(device)
        return model
